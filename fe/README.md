# 🌾 TrustAgri - Zalo Mini App Nông nghiệp

Ứng dụng Zalo Mini App cho nông nghiệp với hệ thống giám sát môi trường, Digital Twin, và quản lý Farm Lab.

## 🎯 Xem Demo nhanh

Sau khi chạy `npm start`, bạn sẽ thấy **menu demo** với 5 kịch bản:

1. **✅ Hoạt động bình thường** - Tất cả cảm biến tốt, không có cảnh báo
2. **⚠️ Cảnh báo nhiệt độ cao** - Nhiệt độ 33°C, cây bị stress
3. **🚨 Tình trạng nguy hiểm** - Nhiệt độ 38°C, nhiều cảnh báo
4. **🌱 Giai đoạn mầm** - Cây non, mới trồng
5. **📊 Dữ liệu bổ khuyết** - Cảm biến offline, dữ liệu ước tính
