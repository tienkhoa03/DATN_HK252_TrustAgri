/**
 * Farmer Dashboard Screen Demo
 * Interactive demo for the Farmer Dashboard Screen
 */
...
export interface FarmerDashboardScreenDemoProps {
  onBack?: () => void;
}

export const FarmerDashboardScreenDemo: React.FC<FarmerDashboardScreenDemoProps> = ({ onBack }) => {
  ...
  return (
    <Page className="farmer-dashboard-demo">
      {/* Back Bar */}
      {onBack && (
...
export default FarmerDashboardScreenDemo;
