/**
 * Trader Profile & News Screen Demo
 * Interactive demo for the Trader Profile & News Screen
 */
...
export interface TraderProfileNewsScreenDemoProps {
  onBack?: () => void;
}

export const TraderProfileNewsScreenDemo: React.FC<TraderProfileNewsScreenDemoProps> = ({ onBack }) => {
  ...
  return (
    <Page className="trader-profile-news-demo">
      {/* Back Bar */}
      {onBack && (
...
export default TraderProfileNewsScreenDemo;
